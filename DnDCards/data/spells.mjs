const spells = [
{
    ...
    casting_time_misc: "",
    component_material: "M",
    component_semantic: true,
    component_verbal: true,
    component_misc: "powdered rhubarb leaf and an adder's stomach",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a tiny strip of white cloth",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a tiny bell and a piece of fine silver wire",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a morsel of food",
    description: `This spell lets you convince a beast that you mean it no harm. Choose a beast that you can see within range. It must see and hear you. If the beast's Intelligence is 4 or higher, the spell fails. Otherwise, the beast must succeed on a Wisdom saving throw or be charmed by you for the spell's duration. If you or one of your companions harms the target, the spells ends.
 <strong>At Higher Levels<strong>. When you cast this spell using a spell slot of 2nd level or higher, you can affect one additional beast t level above 1st.
`,
    duration: "24 hours",
    level: "1st-level",
    range: "30 feet",
...
},
{
 ...
 <strong>At Higher Levels<strong>. If you cast this spell using a spell slot of 3nd level or higher, the duration of the spell increases by 48 hours for each slot level above 2nd.
`,
    duration: "24 hours",
    level: "2nd-level",
    range: "30 feet",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a drop of blood, a piece of flesh, and a pinch of bone dust",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of powdered iron or iron filings",
 ...
 <strong>Areas of Magic<strong>. The area of another spell or magical effect, such as *fireball*, can't extend into the sphere. If the sphere overlaps an area of magic, the part of the area that is covered by the sphere is suppressed. For example, the flames created by a *wall of fire* are suppressed within the sphere, creating a gap in the wall if the overlap is large enough.
 ...
 <strong>Magic Items<strong>. The properties and powers of magic items are suppressed in the sphere. For example, a *+1 longsword* in the sphere functions as a nonmagical longsword.
...
`,
    ...
    level: "8th-level",
    range: "Self",
    range_area: "(10-foot radius sphere)",
    school: "abjuration",
    school_ritual: ""
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "either a lump of alum soaked in vinegar for the *antipathy* effect or a drop of honey for the *sympathy* effect",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of bat fur",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "an eggshell and a snakeskin glove",
 ...
 <strong>Forceful Hand<strong>. The hand attempts to push a creature within 5 feet of it in a direction you choose.
 ...
 <strong>At Higher Levels<strong>. When you cast this spell using a spell slot of 6th level or higher, the damage from the clenched fist option increases by 2d8 and the damage from the grasping hand increases by 2d6 for each slot level above 5th.
`,
    duration: "Concentration, up to 1 minute",
    level: "5th-level",
    range: "120 feet",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "gold dust worth at least 25 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a miniature platinum sword with a grip and pommel of copper and zinc, worth 250 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small square of silk",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "for each creature you affect with this spell, you must provide one jacinth worth at least 1,000 gp and one ornately carved bar of silver worth at least 100 gp, all of which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "specially marked sticks, bones, or similar tokens worth at least 25 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "an agate worth at least 1,000 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a drop of blood",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "an item distasteful to the target",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a handful of oak bark",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a piece of tentacle from a giant octopus or a giant squid",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a sprinkling of holy water",
...
},
{
 ...
 <strong>At Higher Levels<strong>. When you cast this spell using a spell slot of 4th or higher level, the damage increases by 1d10 for each slot level above 3rd.
`,
    duration: "Concentration, up to 10 minutes",
    level: "3rd-level",
    range: "120 feet",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of fur; a piece of amber, glass, or a crystal rod; and three silver pins",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "the powder of a crushed black pearl worth at least 500 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a focus worth at least 100 gp, either a jeweled horn for hearing or a glass eye for seeing",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a diamond worth at least 1,000 gp and at least 1 cubic inch of flesh of the creature that is to be cloned, which the spell consumes, and a vessel worth at least 2,000 gp that has a sealable lid and is large enough to hold a Medium creature, such as a huge urn, coffin, mud-filled cyst in the ground, or crystal container filled with salt water",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of powder or sand that is colored red, yellow, and blue",
...
},
{
 ...
 <strong>Approach<strong>. The target moves toward you by the shortest and most direct route, ending its turn if it moves within 5 feet of you.
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "incense and a vial of holy or unholy water",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of soot and salt",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small crystal or glass cone",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "three nut shells",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "burning incense for air, soft clay for earth, sulfur and phosphorus for fire, or water and sand for water",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "one holly berry per creature summoned",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a statuette of yourself carved from ivory and decorated with gems worth at least 1,500 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "ruby dust worth 50 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a drop of water and a pinch of dust",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "burning incense and bits of earth and wood mixed in water",
...
},
{
    ...
    casting_time_misc: "which you take when you see a creature within 60 feet of you casting a spell",
    component_material: "",
    component_semantic: true,
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "one clay pot filled with grave dirt, one clay pot filled with brackish water, and one 150 gp black onyx stone for each corpse",
 ...
 <strong>At Higher Levels<strong>. When you cast this spell using a 7th-level spell slot, you can animate or reassert control over four ghouls. When you cast this spell using an 8th-level spell slot, you can animate or reassert control over five ghouls or two ghasts or wights. When you cast this spell using a 9th-level spell slot, you can animate or reassert control over six ghouls, three ghasts or wights, or two mummies.
`,
    duration: "Instantaneous",
    level: "6th-level",
    range: "10 feet",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a drop of water if creating water or a few grains of sand if destroying it",
 ...
 <strong>Destroy Water<strong>. You destroy up to 10 gallons of water in an open container within range. Alternatively, you destroy fog in a 30-foot cube within range.
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a tiny piece of matter of the same type of the item you plan to create",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a lodestone and a pinch of dust",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "holy water or powdered silver and iron",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "incense and a sacrificial offering appropriate to your religion, together worth at least 25 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a handful of sand, a dab of ink, and a writing quill plucked from a sleeping bird",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of dirt, a piece of rock, and a lump of clay",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "fur or a feather from a beast",
 ...
 <strong>Bull's Strength<strong>. The target has advantage on Strength checks, and his or her carrying capacity doubles.
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of powdered iron",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a tiny silver whistle, a piece of bone, and a thread",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small amount of alcohol or distilled spirits",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a white feather or the heart of a hen",
...
},
{
    name: "Feather Fall",
    casting_time: "1 reaction,",
    casting_time_misc: "which you take when you or a creature within 60 feet of you falls",
    component_material: "M",
    component_semantic: false,
    component_verbal: true,
    component_misc: "a small feather or piece of down",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a handful of clay, crystal, glass, or mineral spheres",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "10 gp worth of charcoal, incense, and herbs that must be consumed by fire in a brass brazier",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a set of divinatory tools- such as bones, ivory sticks, cards, teeth, or carved runes-worth 100 gp and an object from the location you wish to find",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of phosphorus or a firefly",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "pinch of sulfur",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of tallow, a pinch of brimstone, and a dusting of powdered iron",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of lime, water, and earth",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a drop of mercury",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a wing feather from any bird",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a sprinkling of holy water, rare incense, and powdered ruby worth at least 1,000 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "ruby dust worth 1,500 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a hummingbird feather",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a leather strap, bound around the arm or a similar appendage",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small crystal sphere",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of gauze and a wisp of smoke",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a diamond worth at least 5,000 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of salt and one copper piece placed on each of the corpse's eyes, which must remain there for the duration",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a glass or crystal bead that shatters when the spell ends",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "incense and powdered diamond worth at least 200 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a sprig of mistletoe",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of pork rind or butter",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "diamond dust worth at least 100 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "burning incense, a small measure of brimstone and oil, a knotted string, a small amount of umber hulk blood, and a small silver rod worth at least 10 gp",
 ...
 *Guards and wards* creates the following effects within the warded area.
 ...
 <strong>Doors<strong>. All doors in the warded area are magically locked, as if sealed by an *arcane lock* spell. In addition, you can cover up to ten doors with an illusion (equivalent to the illusory object function of the *minor illusion* spell) to make them appear as plain sections of wall.
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "herbs, oils, and incense worth at least 1,000 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a stone, a twig, and a bit of green plant",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a shaving of licorice root",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a piece of iron and a flame",
...
},
{
    name: "Hellish Rebuke",
    casting_time: "1 reaction",
    casting_time_misc: "which you take in response to being damaged by a creature within 60 feet of you that you can see",
    component_material: "",
    component_semantic: true,
    component_verbal: true,
    component_misc: "",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a gem-encrusted bowl worth at least 1,000 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "tiny tarts and a feather that is waved in the air",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small, straight piece of iron",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a tiny reliquary worth at least 1,000 gp containing a sacred relic, such as a scrap of cloth from a saint's robe or a piece of parchment from a religious text",
...
},
{
    ...
    component_semantic: true,
    component_verbal: false,
    component_misc: "a glowing stick of incense or a crystal vial filled with phosphorescent material",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of dust and a few drops of water",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pearl worth at least 100 gp and an owl feather",
...
},
{
    ...
    component_semantic: true,
    component_verbal: false,
    component_misc: "a lead-based ink worth at least 10 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a vellum depiction or a carved statuette in the likeness of the target, and a special component that varies according to the version of the spell you choose, worth at least 500 gp per Hit Die of the target",
 ...
 <strong>Burial<strong>. The target is entombed far beneath the earth in a sphere of magical force that is just large enough to contain the target. Nothing can pass through the sphere, nor can any creature teleport or use planar travel to get into or out of it.

 The special component for this version of the spell is a small mithral orb.

 <strong>Chaining<strong>. Heavy chains, firmly rooted in the ground, hold the target in place. The target is restrained until the spell ends, and it can't move or be moved by any means until then.

 The special component for this version of the spell is a fine chain of precious metal.

 <strong>Hedged Prison<strong>. The spell transports the target into a tiny demiplane that is warded against teleportation and planar travel. The demiplane can be a labyrinth, a cage, a tower, or any similar confined structure or area of your choice.

 The special component for this version of the spell is a miniature representation of the prison made from jade.

 <strong>Minimus Containment<strong>. The target shrinks to a height of 1 inch and is imprisoned inside a gemstone or similar object. Light can pass through the gemstone normally (allowing the target to see out and other creatures to see in), but nothing else can pass through, even by means of teleportation or planar travel. The gemstone can't be cut or broken while the spell remains in effect.
 ...
 <strong>Ending the Spell<strong>. During the casting of the spell, in any of its versions, you can specify a condition that will cause the spell to end and release the target. The condition can be as specific or as elaborate as you choose, but the GM must agree that the condition is reasonable and has a likelihood of coming to pass. The conditions can be based on a creature's name, identity, or deity but otherwise must be based on observable actions or qualities and not based on intangibles such as level, class, or hit points.
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a few grains of sugar, some kernels of grain, and a smear of fat",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a sapphire worth 1,000 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "an eyelash encased in gum arabic",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a grasshopper's hind leg",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "incense worth at least 250 gp, which the spell consumes, and four ivory strips worth at least 50 gp each",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "either a small leather loop or a piece of golden wire bent into a cup shape with a long shank on one end",
...
},
{
    ...
    component_semantic: false,
    component_verbal: true,
    component_misc: "a firefly or phosphorescent moss",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of fur and a rod of amber, crystal, or glass",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of fur from a bloodhound",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of dirt",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a piece of cured leather",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "holy water or powdered silver and iron worth at least 100 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a gem, crystal, reliquary, or some other ornamental container worth at least 500 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small bit of honeycomb and jade dust worth at least 10 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a miniature portal carved from ivory, a small piece of polished marble, and a tiny silver spoon, each item worth at least 5 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of fleece",
...
},
{
    ...
    component_semantic: false,
    component_verbal: true,
    component_misc: "a snake's tongue and either a bit of honeycomb or a drop of sweet oil",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a short piece of copper wire",
...
},
{
 ...
 <strong>At Higher Levels<strong>. If you cast this spell using a spell slot of 6th level or higher, you can alter the target's memories of an event that took place up to 7 days ago (6th level), 30 days ago (7th level), 1 year ago (8th level), or any time in the creature's past (9th level).
`,
    duration: "Concentration, up to 1 minute",
    level: "5th-level",
    range: "30 feet",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "several seeds of any moonseed plant and a piece of opalescent feldspar",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "an iron blade and a small bag containing a mixture of soils-clay, loam, and sand",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of diamond dust worth 25 gp sprinkled over the target, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "ashes from a burned leaf of mistletoe and a sprig of spruce",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of sesame seeds",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a jewel worth at least 1,000 gp, which the spell consumes",
 ...
 <strong>At Higher Levels<strong>. When you cast this spell using a spell slot of a higher level, the duration increases to 10 days with a 6th-level slot, to 30 days with a 7th-level slot, to 180 days with an 8th-level slot, and to a year and a day with a 9th-level spell slot.
`,
    duration: "24 hours",
    level: "5th-level",
    range: "60 feet",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a forked, metal rod worth at least 250 gp, attuned to a particular plane of existence",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a caterpillar cocoon",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a thin sheet of lead, a piece of opaque glass, a wad of cotton or cloth, and powdered chrysolite",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of fleece and jade dust worth at least 25 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small replica of you made from materials worth at least 5 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "holy water or powdered silver and iron, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a diamond worth at least 500 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a prayer wheel and holy water",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "rare oils and unguents worth at least 1,000 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a hemispherical piece of clear crystal and a matching hemispherical piece of gum arabic",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a miniature cloak",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a diamond worth at least 1,000 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a lodestone and iron filings",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "diamonds worth 300 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "powdered corn extract and a twisted loop of parchment",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small silver mirror",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a focus worth at least 1,000 gp, such as a crystal ball, a silver mirror, or a font filled with holy water",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "an exquisite chest, 3 feet by 2 feet by 2 feet, constructed from rare materials worth at least 5,000 gp, and a Tiny replica made from the same materials worth at least 50 gp",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of talc and a small sprinkling of powdered silver",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a short piece of fine copper wire",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a powder composed of diamond, emerald, ruby, and sapphire dust worth at least 5,000 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a jade circlet worth at least 1,500 gp, which you must place on your head before you cast the spell",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small parchment with a bit of holy text written on it",
...
},
{
    name: "Shield",
    casting_time: "1 reaction",
    casting_time_misc: "which you take when you are hit by an attack or targeted by the *magic missile* spell",
    component_material: "",
    component_semantic: true,
    component_verbal: true,
    component_misc: "",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "mistletoe, a shamrock leaf, and a club or quarterstaff",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "snow or ice in quantities sufficient to made a life-size copy of the duplicated creature; some hair, fingernail clippings, or other piece of that creature's body placed inside the snow or ice; and powdered ruby worth 1,500 gp, sprinkled over the duplicate and consumed by the spell",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of fine sand, rose petals, or a cricket",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a drop of molasses",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "burning incense",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a drop of bitumen and a spider",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "seven sharp thorns or seven small twigs, each sharpened to a point",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a rotten egg or several skunk cabbage leaves",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "soft clay, which must be worked into roughly the desired shape of the stone object",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "diamond dust worth 100 gp, which the spell consumes",
...
},
{
 ...
 <strong>Round 5-10<strong>. Gusts and freezing rain assail the area under the cloud. The area becomes difficult terrain and is heavily obscured. Each creature there takes 1d6 cold damage. Ranged weapon attacks in the area are impossible. The wind and rain count as a severe distraction for the purposes of maintaining concentration on spells. Finally, gusts of strong wind (ranging from 20 to 50 miles per hour) automatically disperse fog, mists, and similar phenomena in the area, whether mundane or magical.
`,
    duration: "Concentration, up to 1 minute",
    level: "9th-level",
    range: "Sight",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a magnifying glass",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "fire and a piece of sunstone",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "mercury, phosphorus, and powdered diamond and opal with a total value of at least 1,000 gp, which the spell consumes",
 ...
 <strong>Fear<strong>. Each target must make a Wisdom saving throw and becomes frightened for 1 minute on a failed save. While frightened, the target drops whatever it is holding and must move at least 30 feet away from the glyph on each of its turns, if able.
 ...
 <strong>Insanity<strong>. Each target must make an Intelligence saving throw. On a failed save, the target is driven insane for 1 minute. An insane creature can't take actions, can't understand what other creatures say, can't read, and speaks only in gibberish. The GM controls its movement, which is erratic.
...
},
{
 ...
 <strong>Object<strong>. You can try to move an object that weighs up to 1,000 pounds. If the object isn't being worn or carried, you automatically move it up to 30 feet in any direction, but not beyond the range of this spell.
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "pieces of eggshell from two different kinds of creatures",
 ...
 **Table- Teleport Familiarity**
 ...
 <strong>Familiarity<strong>. "Permanent circle" means a permanent teleportation circle whose sigil sequence you know. "Associated object" means that you possess an object taken from the desired destination within the last six months, such as a book from a wizard's library, bed linen from a royal suite, or a chunk of marble from a lich's secret tomb.
 ...
 <strong>Off Target<strong>. You and your group (or the target object) appear a random distance away from the destination in a random direction. Distance off target is 1d10 x 1d10 percent of the distance that was to be traveled. For example, if you tried to travel 120 miles, landed off target, and rolled a 5 and 3 on the two d10s, then you would be off target by 15 percent, or 18 miles. The GM determines the direction off target randomly by rolling a d8 and designating 1 as north, 2 as northeast, 3 as east, and so on around the points of the compass. If you were teleporting to a coastal city and wound up 18 miles out at sea, you could be in trouble.

 <strong>Similar Area<strong>. You and your group (or the target object) wind up in a different area that's visually or thematically similar to the target area. If you are heading for your home laboratory, for example, you might wind up in another wizard's laboratory or in an alchemical supply shop that has many of the same tools and implements as your laboratory. Generally, you appear in the closest similar place, but since the spell has no range limit, you could conceivably wind up anywhere on the plane.

 <strong>Mishap<strong>. The spell's unpredictable magic results in a difficult journey. Each teleporting creature (or the target object) takes 3d10 force damage, and the GM rerolls on the table to see where you wind up (multiple mishaps can occur, dealing damage each time).
`,
    duration: "Instantaneous",
    level: "7th-level",
    range: "10 feet",
...
},
{
    ...
    component_semantic: false,
    component_verbal: true,
    component_misc: "rare chalks and inks infused with precious gems with 50 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small crystal bead",
...
`,
    ...
    level: "3rd-level",
    range: "Self",
    range_area: "(10-foot radius hemisphere)",
    school: "evocation",
    school_ritual: "(ritual)"
},
{
    ...
    component_semantic: false,
    component_verbal: true,
    component_misc: "a small clay model of a ziggurat",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a drop of mercury, a dollop of gum arabic, and a wisp of smoke",
    description: `Choose one creature or nonmagical object that you can see within range. You transform the creature into a different creature, the creature into a nonmagical object, or the object into a creature (the object must be neither worn nor carried by another creature). The transformation lasts for the duration, or until the target drops to 0 hit points or dies. If you concentrate on this spell for the full duration, the transformation lasts until it is dispelled.
 This spell has no effect on a shapechanger or a creature with 0 hit points. An unwilling creature can make a Wisdom saving throw, and if it succeeds, it isn't affected by this spell.

 <strong>Creature into Creature<strong>. If you turn a creature into another kind of creature, the new form can be any kind you choose whose challenge rating is equal to or less than the target's (or its level, if the target doesn't have a challenge rating). The target's game statistics, including mental ability scores, are replaced by the statistics of the new form. It retains its alignment and personality.
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a sprinkle of holy water and diamonds worth at least 25,000 gp, which the spell consumes",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "an ointment for the eyes that costs 25 gp; is made from mushroom powder, saffron, and fat; and is consumed by the spell",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a piece of string and a bit of wood",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small piece of phosphorus",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pinch of powder made by crushing a clear gemstone",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small piece of quartz",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a small block of granite",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a handful of thorns",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a pair of platinum rings worth at least 50 gp each, which you and the target must wear for the duration",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a short reed or piece of straw",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a piece of cork",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a bit of spiderweb",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "fire and holy water",
...
},
{
    ...
    component_semantic: true,
    component_verbal: true,
    component_misc: "a tiny fan and a feather of exotic origin",
...
},
{
    ...
    component_verbal: true,
    component_misc: "",
    description: `The basic use of this spell is to duplicate any other spell of 8th level or lower. You don't need to meet any requirements in that spell, including costly components. The spell simply takes effect.
